 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(t){function e(K,F){var H=K.length;K.push(F);e:for(;0<H;){var L=H-1>>>1,O=K[L];if(0<i(O,F))K[L]=F,K[H]=O,H=L;else break e}}function n(K){return K.length===0?null:K[0]}function r(K){if(K.length===0)return null;var F=K[0],H=K.pop();if(H!==F){K[0]=H;e:for(var L=0,O=K.length,G=O>>>1;L<G;){var ue=2*(L+1)-1,ge=K[ue],ce=ue+1,Q=K[ce];if(0>i(ge,H))ce<O&&0>i(Q,ge)?(K[L]=Q,K[ce]=H,L=ce):(K[L]=ge,K[ue]=H,L=ue);else if(ce<O&&0>i(Q,H))K[L]=Q,K[ce]=H,L=ce;else break e}}return F}function i(K,F){var H=K.sortIndex-F.sortIndex;return H!==0?H:K.id-F.id}if(typeof performance=="object"&&typeof performance.now=="function"){var s=performance;t.unstable_now=function(){return s.now()}}else{var o=Date,u=o.now();t.unstable_now=function(){return o.now()-u}}var c=[],d=[],m=1,p=null,_=3,C=!1,R=!1,k=!1,D=typeof setTimeout=="function"?setTimeout:null,b=typeof clearTimeout=="function"?clearTimeout:null,g=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function S(K){for(var F=n(d);F!==null;){if(F.callback===null)r(d);else if(F.startTime<=K)r(d),F.sortIndex=F.expirationTime,e(c,F);else break;F=n(d)}}function V(K){if(k=!1,S(K),!R)if(n(c)!==null)R=!0,et(j);else{var F=n(d);F!==null&&rn(V,F.startTime-K)}}function j(K,F){R=!1,k&&(k=!1,b(y),y=-1),C=!0;var H=_;try{for(S(F),p=n(c);p!==null&&(!(p.expirationTime>F)||K&&!w());){var L=p.callback;if(typeof L=="function"){p.callback=null,_=p.priorityLevel;var O=L(p.expirationTime<=F);F=t.unstable_now(),typeof O=="function"?p.callback=O:p===n(c)&&r(c),S(F)}else r(c);p=n(c)}if(p!==null)var G=!0;else{var ue=n(d);ue!==null&&rn(V,ue.startTime-F),G=!1}return G}finally{p=null,_=H,C=!1}}var B=!1,v=null,y=-1,T=5,E=-1;function w(){return!(t.unstable_now()-E<T)}function A(){if(v!==null){var K=t.unstable_now();E=K;var F=!0;try{F=v(!0,K)}finally{F?I():(B=!1,v=null)}}else B=!1}var I;if(typeof g=="function")I=function(){g(A)};else if(typeof MessageChannel<"u"){var Ce=new MessageChannel,Ye=Ce.port2;Ce.port1.onmessage=A,I=function(){Ye.postMessage(null)}}else I=function(){D(A,0)};function et(K){v=K,B||(B=!0,I())}function rn(K,F){y=D(function(){K(t.unstable_now())},F)}t.unstable_IdlePriority=5,t.unstable_ImmediatePriority=1,t.unstable_LowPriority=4,t.unstable_NormalPriority=3,t.unstable_Profiling=null,t.unstable_UserBlockingPriority=2,t.unstable_cancelCallback=function(K){K.callback=null},t.unstable_continueExecution=function(){R||C||(R=!0,et(j))},t.unstable_forceFrameRate=function(K){0>K||125<K?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):T=0<K?Math.floor(1e3/K):5},t.unstable_getCurrentPriorityLevel=function(){return _},t.unstable_getFirstCallbackNode=function(){return n(c)},t.unstable_next=function(K){switch(_){case 1:case 2:case 3:var F=3;break;default:F=_}var H=_;_=F;try{return K()}finally{_=H}},t.unstable_pauseExecution=function(){},t.unstable_requestPaint=function(){},t.unstable_runWithPriority=function(K,F){switch(K){case 1:case 2:case 3:case 4:case 5:break;default:K=3}var H=_;_=K;try{return F()}finally{_=H}},t.unstable_scheduleCallback=function(K,F,H){var L=t.unstable_now();switch(typeof H=="object"&&H!==null?(H=H.delay,H=typeof H=="number"&&0<H?L+H:L):H=L,K){case 1:var O=-1;break;case 2:O=250;break;case 5:O=1073741823;break;case 4:O=1e4;break;default:O=5e3}return O=H+O,K={id:m++,callback:F,priorityLevel:K,startTime:H,expirationTime:O,sortIndex:-1},H>L?(K.sortIndex=H,e(d,K),n(c)===null&&K===n(d)&&(k?(b(y),y=-1):k=!0,rn(V,H-L))):(K.sortIndex=O,e(c,K),R||C||(R=!0,et(j))),K},t.unstable_shouldYield=w,t.unstable_wrapCallback=function(K){var F=_;return function(){var H=_;_=F;try{return K.apply(this,arguments)}finally{_=H}}}})(ty);ey.exports=ty;var ox=ey.exports;/**
 * @license React
...
*/var jr,pv;(function(){var t;/** @license
 ...
 Copyright The Closure Library Authors.
 SPDX-License-Identifier: Apache-2.0
*/function e(v,y){function T(){}T.prototype=y.prototype,v.F=y.prototype,v.prototype=new T,v.prototype.constructor=v,v.D=function(E,w,A){for(var I=Array(arguments.length-2),Ce=2;Ce<arguments.length;Ce++)I[Ce-2]=arguments[Ce];return y.prototype[w].apply(E,I)}}function n(){this.blockSize=-1}function r(){this.blockSize=-1,this.blockSize=64,this.g=Array(4),this.C=Array(this.blockSize),this.o=this.h=0,this.u()}e(r,n),r.prototype.u=function(){this.g[0]=1732584193,this.g[1]=4023233417,this.g[2]=2562383102,this.g[3]=271733878,this.o=this.h=0};function i(v,y,T){T||(T=0);const E=Array(16);if(typeof y=="string")for(var w=0;w<16;++w)E[w]=y.charCodeAt(T++)|y.charCodeAt(T++)<<8|y.charCodeAt(T++)<<16|y.charCodeAt(T++)<<24;else for(w=0;w<16;++w)E[w]=y[T++]|y[T++]<<8|y[T++]<<16|y[T++]<<24;y=v.g[0],T=v.g[1],w=v.g[2];let A=v.g[3],I;I=y+(A^T&(w^A))+E[0]+3614090360&4294967295,y=T+(I<<7&4294967295|I>>>25),I=A+(w^y&(T^w))+E[1]+3905402710&4294967295,A=y+(I<<12&4294967295|I>>>20),I=w+(T^A&(y^T))+E[2]+606105819&4294967295,w=A+(I<<17&4294967295|I>>>15),I=T+(y^w&(A^y))+E[3]+3250441966&4294967295,T=w+(I<<22&4294967295|I>>>10),I=y+(A^T&(w^A))+E[4]+4118548399&4294967295,y=T+(I<<7&4294967295|I>>>25),I=A+(w^y&(T^w))+E[5]+1200080426&4294967295,A=y+(I<<12&4294967295|I>>>20),I=w+(T^A&(y^T))+E[6]+2821735955&4294967295,w=A+(I<<17&4294967295|I>>>15),I=T+(y^w&(A^y))+E[7]+4249261313&4294967295,T=w+(I<<22&4294967295|I>>>10),I=y+(A^T&(w^A))+E[8]+1770035416&4294967295,y=T+(I<<7&4294967295|I>>>25),I=A+(w^y&(T^w))+E[9]+2336552879&4294967295,A=y+(I<<12&4294967295|I>>>20),I=w+(T^A&(y^T))+E[10]+4294925233&4294967295,w=A+(I<<17&4294967295|I>>>15),I=T+(y^w&(A^y))+E[11]+2304563134&4294967295,T=w+(I<<22&4294967295|I>>>10),I=y+(A^T&(w^A))+E[12]+1804603682&4294967295,y=T+(I<<7&4294967295|I>>>25),I=A+(w^y&(T^w))+E[13]+4254626195&4294967295,A=y+(I<<12&4294967295|I>>>20),I=w+(T^A&(y^T))+E[14]+2792965006&4294967295,w=A+(I<<17&4294967295|I>>>15),I=T+(y^w&(A^y))+E[15]+1236535329&4294967295,T=w+(I<<22&4294967295|I>>>10),I=y+(w^A&(T^w))+E[1]+4129170786&4294967295,y=T+(I<<5&4294967295|I>>>27),I=A+(T^w&(y^T))+E[6]+3225465664&4294967295,A=y+(I<<9&4294967295|I>>>23),I=w+(y^T&(A^y))+E[11]+643717713&4294967295,w=A+(I<<14&4294967295|I>>>18),I=T+(A^y&(w^A))+E[0]+3921069994&4294967295,T=w+(I<<20&4294967295|I>>>12),I=y+(w^A&(T^w))+E[5]+3593408605&4294967295,y=T+(I<<5&4294967295|I>>>27),I=A+(T^w&(y^T))+E[10]+38016083&4294967295,A=y+(I<<9&4294967295|I>>>23),I=w+(y^T&(A^y))+E[15]+3634488961&4294967295,w=A+(I<<14&4294967295|I>>>18),I=T+(A^y&(w^A))+E[4]+3889429448&4294967295,T=w+(I<<20&4294967295|I>>>12),I=y+(w^A&(T^w))+E[9]+568446438&4294967295,y=T+(I<<5&4294967295|I>>>27),I=A+(T^w&(y^T))+E[14]+3275163606&4294967295,A=y+(I<<9&4294967295|I>>>23),I=w+(y^T&(A^y))+E[3]+4107603335&4294967295,w=A+(I<<14&4294967295|I>>>18),I=T+(A^y&(w^A))+E[8]+1163531501&4294967295,T=w+(I<<20&4294967295|I>>>12),I=y+(w^A&(T^w))+E[13]+2850285829&4294967295,y=T+(I<<5&4294967295|I>>>27),I=A+(T^w&(y^T))+E[2]+4243563512&4294967295,A=y+(I<<9&4294967295|I>>>23),I=w+(y^T&(A^y))+E[7]+1735328473&4294967295,w=A+(I<<14&4294967295|I>>>18),I=T+(A^y&(w^A))+E[12]+2368359562&4294967295,T=w+(I<<20&4294967295|I>>>12),I=y+(T^w^A)+E[5]+4294588738&4294967295,y=T+(I<<4&4294967295|I>>>28),I=A+(y^T^w)+E[8]+2272392833&4294967295,A=y+(I<<11&4294967295|I>>>21),I=w+(A^y^T)+E[11]+1839030562&4294967295,w=A+(I<<16&4294967295|I>>>16),I=T+(w^A^y)+E[14]+4259657740&4294967295,T=w+(I<<23&4294967295|I>>>9),I=y+(T^w^A)+E[1]+2763975236&4294967295,y=T+(I<<4&4294967295|I>>>28),I=A+(y^T^w)+E[4]+1272893353&4294967295,A=y+(I<<11&4294967295|I>>>21),I=w+(A^y^T)+E[7]+4139469664&4294967295,w=A+(I<<16&4294967295|I>>>16),I=T+(w^A^y)+E[10]+3200236656&4294967295,T=w+(I<<23&4294967295|I>>>9),I=y+(T^w^A)+E[13]+681279174&4294967295,y=T+(I<<4&4294967295|I>>>28),I=A+(y^T^w)+E[0]+3936430074&4294967295,A=y+(I<<11&4294967295|I>>>21),I=w+(A^y^T)+E[3]+3572445317&4294967295,w=A+(I<<16&4294967295|I>>>16),I=T+(w^A^y)+E[6]+76029189&4294967295,T=w+(I<<23&4294967295|I>>>9),I=y+(T^w^A)+E[9]+3654602809&4294967295,y=T+(I<<4&4294967295|I>>>28),I=A+(y^T^w)+E[12]+3873151461&4294967295,A=y+(I<<11&4294967295|I>>>21),I=w+(A^y^T)+E[15]+530742520&4294967295,w=A+(I<<16&4294967295|I>>>16),I=T+(w^A^y)+E[2]+3299628645&4294967295,T=w+(I<<23&4294967295|I>>>9),I=y+(w^(T|~A))+E[0]+4096336452&4294967295,y=T+(I<<6&4294967295|I>>>26),I=A+(T^(y|~w))+E[7]+1126891415&4294967295,A=y+(I<<10&4294967295|I>>>22),I=w+(y^(A|~T))+E[14]+2878612391&4294967295,w=A+(I<<15&4294967295|I>>>17),I=T+(A^(w|~y))+E[5]+4237533241&4294967295,T=w+(I<<21&4294967295|I>>>11),I=y+(w^(T|~A))+E[12]+1700485571&4294967295,y=T+(I<<6&4294967295|I>>>26),I=A+(T^(y|~w))+E[3]+2399980690&4294967295,A=y+(I<<10&4294967295|I>>>22),I=w+(y^(A|~T))+E[10]+4293915773&4294967295,w=A+(I<<15&4294967295|I>>>17),I=T+(A^(w|~y))+E[1]+2240044497&4294967295,T=w+(I<<21&4294967295|I>>>11),I=y+(w^(T|~A))+E[8]+1873313359&4294967295,y=T+(I<<6&4294967295|I>>>26),I=A+(T^(y|~w))+E[15]+4264355552&4294967295,A=y+(I<<10&4294967295|I>>>22),I=w+(y^(A|~T))+E[6]+2734768916&4294967295,w=A+(I<<15&4294967295|I>>>17),I=T+(A^(w|~y))+E[13]+1309151649&4294967295,T=w+(I<<21&4294967295|I>>>11),I=y+(w^(T|~A))+E[4]+4149444226&4294967295,y=T+(I<<6&4294967295|I>>>26),I=A+(T^(y|~w))+E[11]+3174756917&4294967295,A=y+(I<<10&4294967295|I>>>22),I=w+(y^(A|~T))+E[2]+718787259&4294967295,w=A+(I<<15&4294967295|I>>>17),I=T+(A^(w|~y))+E[9]+3951481745&4294967295,v.g[0]=v.g[0]+y&4294967295,v.g[1]=v.g[1]+(w+(I<<21&4294967295|I>>>11))&4294967295,v.g[2]=v.g[2]+w&4294967295,v.g[3]=v.g[3]+A&4294967295}r.prototype.v=function(v,y){y===void 0&&(y=v.length);const T=y-this.blockSize,E=this.C;let w=this.h,A=0;for(;A<y;){if(w==0)for(;A<=T;)i(this,v,A),A+=this.blockSize;if(typeof v=="string"){for(;A<y;)if(E[w++]=v.charCodeAt(A++),w==this.blockSize){i(this,E),w=0;break}}else for(;A<y;)if(E[w++]=v[A++],w==this.blockSize){i(this,E),w=0;break}}this.h=w,this.o+=y},r.prototype.A=function(){var v=Array((this.h<56?this.blockSize:this.blockSize*2)-this.h);v[0]=128;for(var y=1;y<v.length-8;++y)v[y]=0;y=this.o*8;for(var T=v.length-8;T<v.length;++T)v[T]=y&255,y/=256;for(this.v(v),v=Array(16),y=0,T=0;T<4;++T)for(let E=0;E<32;E+=8)v[y++]=this.g[T]>>>E&255;return v};function s(v,y){var T=u;return Object.prototype.hasOwnProperty.call(T,v)?T[v]:T[v]=y(v)}function o(v,y){this.h=y;const T=[];let E=!0;for(let w=v.length-1;w>=0;w--){const A=v[w]|0;E&&A==y||(T[w]=A,E=!1)}this.g=T}var u={};function c(v){return-128<=v&&v<128?s(v,function(y){return new o([y|0],y<0?-1:0)}):new o([v|0],v<0?-1:0)}function d(v){if(isNaN(v)||!isFinite(v))return p;if(v<0)return D(d(-v));const y=[];let T=1;for(let E=0;v>=T;E++)y[E]=v/T|0,T*=4294967296;return new o(y,0)}function m(v,y){if(v.length==0)throw Error("number format error: empty string");if(y=y||10,y<2||36<y)throw Error("radix out of range: "+y);if(v.charAt(0)=="-")return D(m(v.substring(1),y));if(v.indexOf("-")>=0)throw Error('number format error: interior "-" character');const T=d(Math.pow(y,8));let E=p;for(let A=0;A<v.length;A+=8){var w=Math.min(8,v.length-A);const I=parseInt(v.substring(A,A+w),y);w<8?(w=d(Math.pow(y,w)),E=E.j(w).add(d(I))):(E=E.j(T),E=E.add(d(I)))}return E}var p=c(0),_=c(1),C=c(16777216);t=o.prototype,t.m=function(){if(k(this))return-D(this).m();let v=0,y=1;for(let T=0;T<this.g.length;T++){const E=this.i(T);v+=(E>=0?E:4294967296+E)*y,y*=4294967296}return v},t.toString=function(v){if(v=v||10,v<2||36<v)throw Error("radix out of range: "+v);if(R(this))return"0";if(k(this))return"-"+D(this).toString(v);const y=d(Math.pow(v,6));var T=this;let E="";for(;;){const w=V(T,y).g;T=b(T,w.j(y));let A=((T.g.length>0?T.g[0]:T.h)>>>0).toString(v);if(T=w,R(T))return A+E;for(;A.length<6;)A="0"+A;E=A+E}},t.i=function(v){return v<0?0:v<this.g.length?this.g[v]:this.h};function R(v){if(v.h!=0)return!1;for(let y=0;y<v.g.length;y++)if(v.g[y]!=0)return!1;return!0}function k(v){return v.h==-1}t.l=function(v){return v=b(this,v),k(v)?-1:R(v)?0:1};function D(v){const y=v.g.length,T=[];for(let E=0;E<y;E++)T[E]=~v.g[E];return new o(T,~v.h).add(_)}t.abs=function(){return k(this)?D(this):this},t.add=function(v){const y=Math.max(this.g.length,v.g.length),T=[];let E=0;for(let w=0;w<=y;w++){let A=E+(this.i(w)&65535)+(v.i(w)&65535),I=(A>>>16)+(this.i(w)>>>16)+(v.i(w)>>>16);E=I>>>16,A&=65535,I&=65535,T[w]=I<<16|A}return new o(T,T[T.length-1]&-2147483648?-1:0)};function b(v,y){return v.add(D(y))}t.j=function(v){if(R(this)||R(v))return p;if(k(this))return k(v)?D(this).j(D(v)):D(D(this).j(v));if(k(v))return D(this.j(D(v)));if(this.l(C)<0&&v.l(C)<0)return d(this.m()*v.m());const y=this.g.length+v.g.length,T=[];for(var E=0;E<2*y;E++)T[E]=0;for(E=0;E<this.g.length;E++)for(let w=0;w<v.g.length;w++){const A=this.i(E)>>>16,I=this.i(E)&65535,Ce=v.i(w)>>>16,Ye=v.i(w)&65535;T[2*E+2*w]+=I*Ye,g(T,2*E+2*w),T[2*E+2*w+1]+=A*Ye,g(T,2*E+2*w+1),T[2*E+2*w+1]+=I*Ce,g(T,2*E+2*w+1),T[2*E+2*w+2]+=A*Ce,g(T,2*E+2*w+2)}for(v=0;v<y;v++)T[v]=T[2*v+1]<<16|T[2*v];for(v=y;v<2*y;v++)T[v]=0;return new o(T,0)};function g(v,y){for(;(v[y]&65535)!=v[y];)v[y+1]+=v[y]>>>16,v[y]&=65535,y++}function S(v,y){this.g=v,this.h=y}function V(v,y){if(R(y))throw Error("division by zero");if(R(v))return new S(p,p);if(k(v))return y=V(D(v),y),new S(D(y.g),D(y.h));if(k(y))return y=V(v,D(y)),new S(D(y.g),y.h);if(v.g.length>30){if(k(v)||k(y))throw Error("slowDivide_ only works with positive integers.");for(var T=_,E=y;E.l(v)<=0;)T=j(T),E=j(E);var w=B(T,1),A=B(E,1);for(E=B(E,2),T=B(T,2);!R(E);){var I=A.add(E);I.l(v)<=0&&(w=w.add(T),A=I),E=B(E,1),T=B(T,1)}return y=b(v,w.j(y)),new S(w,y)}for(w=p;v.l(y)>=0;){for(T=Math.max(1,Math.floor(v.m()/y.m())),E=Math.ceil(Math.log(T)/Math.LN2),E=E<=48?1:Math.pow(2,E-48),A=d(T),I=A.j(y);k(I)||I.l(v)>0;)T-=E,A=d(T),I=A.j(y);R(A)&&(A=_),w=w.add(A),v=b(v,I)}return new S(w,v)}t.B=function(v){return V(this,v).h},t.and=function(v){const y=Math.max(this.g.length,v.g.length),T=[];for(let E=0;E<y;E++)T[E]=this.i(E)&v.i(E);return new o(T,this.h&v.h)},t.or=function(v){const y=Math.max(this.g.length,v.g.length),T=[];for(let E=0;E<y;E++)T[E]=this.i(E)|v.i(E);return new o(T,this.h|v.h)},t.xor=function(v){const y=Math.max(this.g.length,v.g.length),T=[];for(let E=0;E<y;E++)T[E]=this.i(E)^v.i(E);return new o(T,this.h^v.h)};function j(v){const y=v.g.length+1,T=[];for(let E=0;E<y;E++)T[E]=v.i(E)<<1|v.i(E-1)>>>31;return new o(T,v.h)}function B(v,y){const T=y>>5;y%=32;const E=v.g.length-T,w=[];for(let A=0;A<E;A++)w[A]=y>0?v.i(A+T)>>>y|v.i(A+T+1)<<32-y:v.i(A+T);return new o(w,v.h)}r.prototype.digest=r.prototype.A,r.prototype.reset=r.prototype.u,r.prototype.update=r.prototype.v,pv=r,o.prototype.add=o.prototype.add,o.prototype.multiply=o.prototype.j,o.prototype.modulo=o.prototype.B,o.prototype.compare=o.prototype.l,o.prototype.toNumber=o.prototype.m,o.prototype.toString=o.prototype.toString,o.prototype.getBits=o.prototype.i,o.fromNumber=d,o.fromString=m,jr=o}).apply(typeof jm<"u"?jm:typeof self<"u"?self:typeof window<"u"?window:{});var Ra=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};/** @license
Copyright The Closure Library Authors.
SPDX-License-Identifier: Apache-2.0
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class z{constructor(e){this.nextCallback=null,this.catchCallback=null,this.result=void 0,this.error=void 0,this.isDone=!1,this.callbackAttached=!1,e(n=>{this.isDone=!0,this.result=n,this.nextCallback&&this.nextCallback(n)},n=>{this.isDone=!0,this.error=n,this.catchCallback&&this.catchCallback(n)})}catch(e){return this.next(void 0,e)}next(e,n){return this.callbackAttached&&de(59440),this.callbackAttached=!0,this.isDone?this.error?this.wrapFailure(n,this.error):this.wrapSuccess(e,this.result):new z((r,i)=>{this.nextCallback=s=>{this.wrapSuccess(e,s).next(r,i)},this.catchCallback=s=>{this.wrapFailure(n,s).next(r,i)}})}toPromise(){return new Promise((e,n)=>{this.next(e,n)})}wrapUserFunction(e){try{const n=e();return n instanceof z?n:z.resolve(n)}catch(n){return z.reject(n)}}wrapSuccess(e,n){return e?this.wrapUserFunction(()=>e(n)):z.resolve(n)}wrapFailure(e,n){return e?this.wrapUserFunction(()=>e(n)):z.reject(n)}static resolve(e){return new z((n,r)=>{n(e)})}static reject(e){return new z((n,r)=>{r(e)})}static waitFor(e){return new z((n,r)=>{let i=0,s=0,o=!1;e.forEach(u=>{++i,u.next(()=>{++s,o&&s===i&&n()},c=>r(c))}),o=!0,s===i&&n()})}static or(e){let n=z.resolve(!1);for(const r of e)n=n.next(i=>i?z.resolve(i):r());return n}static forEach(e,n){const r=[];return e.forEach((i,s)=>{r.push(n.call(this,i,s))}),this.waitFor(r)}static mapArray(e,n){return new z((r,i)=>{const s=e.length,o=new Array(s);let u=0;for(let c=0;c<s;c++){const d=c;n(e[d]).next(m=>{o[d]=m,++u,u===s&&r(o)},m=>i(m))}})}static doWhile(e,n){return new z((r,i)=>{const s=()=>{e()===!0?n().next(()=>{s()},i):r()};s()})}}function d2(t){const e=t.match(/Android ([\d.]+)/i),n=e?e[1].split(".").slice(0,2).join("."):"-1";return Number(n)}function Ts(t){return t.name==="IndexedDbTransactionError"}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class DS{constructor(){this.overlays=new Qe(le.comparator),this.Lr=new Map}getOverlay(e,n){return z.resolve(this.overlays.get(n))}getOverlays(e,n){const r=oi();return z.forEach(n,i=>this.getOverlay(e,i).next(s=>{s!==null&&r.set(i,s)})).next(()=>r)}saveOverlays(e,n,r){return r.forEach((i,s)=>{this.St(e,n,s)}),z.resolve()}removeOverlaysForBatchId(e,n,r){const i=this.Lr.get(r);return i!==void 0&&(i.forEach(s=>this.overlays=this.overlays.remove(s)),this.Lr.delete(r)),z.resolve()}getOverlaysForCollection(e,n,r){const i=oi(),s=n.length+1,o=new le(n.child("")),u=this.overlays.getIteratorFrom(o);for(;u.hasNext();){const c=u.getNext().value,d=c.getKey();if(!n.isPrefixOf(d.path))break;d.path.length===s&&c.largestBatchId>r&&i.set(c.getKey(),c)}return z.resolve(i)}getOverlaysForCollectionGroup(e,n,r,i){let s=new Qe((d,m)=>d-m);const o=this.overlays.getIterator();for(;o.hasNext();){const d=o.getNext().value;if(d.getKey().getCollectionGroup()===n&&d.largestBatchId>r){let m=s.get(d.largestBatchId);m===null&&(m=oi(),s=s.insert(d.largestBatchId,m)),m.set(d.getKey(),d)}}const u=oi(),c=s.getIterator();for(;c.hasNext()&&(c.getNext().value.forEach((d,m)=>u.set(d,m)),!(u.size()>=i)););return z.resolve(u)}St(e,n,r){const i=this.overlays.get(r.key);if(i!==null){const o=this.Lr.get(i.largestBatchId).delete(r.key);this.Lr.set(i.largestBatchId,o)}this.overlays=this.overlays.insert(r.key,new J2(n,r));let s=this.Lr.get(n);s===void 0&&(s=Te(),this.Lr.set(n,s)),this.Lr.set(n,s.add(r.key))}}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class VS{constructor(){this.sessionToken=Tt.EMPTY_BYTE_STRING}getSessionToken(e){return z.resolve(this.sessionToken)}setSessionToken(e,n){return this.sessionToken=n,z.resolve()}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class US{constructor(){this.Rs=!1,this.As=!1,this.Vs=100,this.ds=function(){return RE()?8:d2(kE())>0?6:4}()}initialize(e,n){this.fs=e,this.indexManager=n,this.Rs=!0}getDocumentsMatchingQuery(e,n,r,i){const s={result:null};return this.gs(e,n).next(o=>{s.result=o}).next(()=>{if(!s.result)return this.ps(e,n,i,r).next(o=>{s.result=o})}).next(()=>{if(s.result)return;const o=new BS;return this.ys(e,n,o).next(u=>{if(s.result=u,this.As)return this.ws(e,n,o,u.size)})}).next(()=>s.result)}ws(e,n,r,i){return r.documentReadCount<this.Vs?(Di()<=Ie.DEBUG&&J("QueryEngine","SDK will not create cache indexes for query:",Vi(n),"since it only creates cache indexes for collection contains","more than or equal to",this.Vs,"documents"),z.resolve()):(Di()<=Ie.DEBUG&&J("QueryEngine","Query:",Vi(n),"scans",r.documentReadCount,"local documents and returns",i,"documents as results."),r.documentReadCount>this.ds*i?(Di()<=Ie.DEBUG&&J("QueryEngine","The SDK decides to create cache indexes for query:",Vi(n),"as using cache indexes may help improve performance."),this.indexManager.createTargetIndexes(e,Mn(n))):z.resolve())}gs(e,n){if(Ym(n))return z.resolve(null);let r=Mn(n);return this.indexManager.getIndexType(e,r).next(i=>i===0?null:(n.limit!==null&&i===1&&(n=Dd(n,null,"F"),r=Mn(n)),this.indexManager.getDocumentsMatchingTarget(e,r).next(s=>{const o=Te(...s);return this.fs.getDocuments(e,o).next(u=>this.indexManager.getMinOffset(e,r).next(c=>{const d=this.Ss(n,u);return this.bs(n,d,o,c.readTime)?this.gs(e,Dd(n,null,"F")):this.Ds(e,d,n,c)}))})))}ps(e,n,r,i){return Ym(n)||i.isEqual(pe.min())?z.resolve(null):this.fs.getDocuments(e,r).next(s=>{const o=this.Ss(n,s);return this.bs(n,o,r,i)?z.resolve(null):(Di()<=Ie.DEBUG&&J("QueryEngine","Re-using previous result from %s to execute query: %s",i.toString(),Vi(n)),this.Ds(e,o,n,o2(i,Do)).next(u=>u))})}Ss(e,n){let r=new dt(Bv(e));return n.forEach((i,s)=>{fu(e,s)&&(r=r.add(s))}),r}bs(e,n,r,i){if(e.limit===null)return!1;if(r.size!==n.size)return!0;const s=e.limitType==="F"?n.last():n.first();return!!s&&(s.hasPendingWrites||s.version.compareTo(i)>0)}ys(e,n,r){return Di()<=Ie.DEBUG&&J("QueryEngine","Using full collection scan to execute query:",Vi(n)),this.fs.getDocumentsMatchingQuery(e,n,Lr.min(),r)}Ds(e,n,r,i){return this.fs.getDocumentsMatchingQuery(e,r,i).next(s=>(n.forEach(o=>{s=s.insert(o.key,o)}),s))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const At="WebChannelConnection",Hs=(t,e,n)=>{t.listen(e,r=>{try{n(r)}catch(i){setTimeout(()=>{throw i},0)}})};class ns extends tb{constructor(e){super(e),this.a_=[],this.forceLongPolling=e.forceLongPolling,this.autoDetectLongPolling=e.autoDetectLongPolling,this.useFetchStreams=e.useFetchStreams,this.longPollingOptions=e.longPollingOptions}static u_(){if(!ns.c_){const e=vv();Hs(e,yv.STAT_EVENT,n=>{n.stat===Ad.PROXY?J(At,"STAT_EVENT: detected buffering proxy"):n.stat===Ad.NOPROXY&&J(At,"STAT_EVENT: detected no buffering proxy")}),ns.c_=!0}}zo(e,n,r,i,s){const o=zd();return new Promise((u,c)=>{const d=new mv;d.setWithCredentials(!0),d.listenOnce(gv.COMPLETE,()=>{try{switch(d.getLastErrorCode()){case Ya.NO_ERROR:const p=d.getResponseJson();J(At,`XHR for RPC '${e}' ${o} received:`,JSON.stringify(p)),u(p);break;case Ya.TIMEOUT:J(At,`RPC '${e}' ${o} timed out`),c(new oe(U.DEADLINE_EXCEEDED,"Request time out"));break;case Ya.HTTP_ERROR:const _=d.getStatus();if(J(At,`RPC '${e}' ${o} failed with status:`,_,"response text:",d.getResponseText()),_>0){let C=d.getResponseJson();Array.isArray(C)&&(C=C[0]);const R=C==null?void 0:C.error;if(R&&R.status&&R.message){const k=function(b){const g=b.toLowerCase().replace(/_/g,"-");return Object.values(U).indexOf(g)>=0?g:U.UNKNOWN}(R.status);c(new oe(k,R.message))}else c(new oe(U.UNKNOWN,"Server responded with status "+d.getStatus()))}else c(new oe(U.UNAVAILABLE,"Connection failed."));break;default:de(9055,{l_:e,streamId:o,h_:d.getLastErrorCode(),P_:d.getLastError()})}}finally{J(At,`RPC '${e}' ${o} completed.`)}});const m=JSON.stringify(i);J(At,`RPC '${e}' ${o} sending request:`,i),d.send(n,"POST",m,r,15)})}T_(e,n,r){const i=zd(),s=[this.Ko,"/","google.firestore.v1.Firestore","/",e,"/channel"],o=this.createWebChannelTransport(),u={httpSessionIdParam:"gsessionid",initMessageHeaders:{},messageUrlParams:{database:`projects/${this.databaseId.projectId}/databases/${this.databaseId.database}`},sendRawJson:!0,supportsCrossDomainXhr:!0,internalChannelParams:{forwardChannelRequestTimeoutMs:6e5},forceLongPolling:this.forceLongPolling,detectBufferingProxy:this.autoDetectLongPolling},c=this.longPollingOptions.timeoutSeconds;c!==void 0&&(u.longPollingTimeout=Math.round(1e3*c)),this.useFetchStreams&&(u.useFetchStreams=!0),this.Go(u.initMessageHeaders,n,r),u.encodeInitMessageHeaders=!0;const d=s.join("");J(At,`Creating RPC '${e}' stream ${i}: ${d}`,u);const m=o.createWebChannel(d,u);this.E_(m);let p=!1,_=!1;const C=new nb({Jo:R=>{_?J(At,`Not sending because RPC '${e}' stream ${i} is closed:`,R):(p||(J(At,`Opening RPC '${e}' stream ${i} transport.`),m.open(),p=!0),J(At,`RPC '${e}' stream ${i} sending:`,R),m.send(R))},Ho:()=>m.close()});return Hs(m,Ys.EventType.OPEN,()=>{_||(J(At,`RPC '${e}' stream ${i} transport opened.`),C.i_())}),Hs(m,Ys.EventType.CLOSE,()=>{_||(_=!0,J(At,`RPC '${e}' stream ${i} transport closed`),C.o_(),this.I_(m))}),Hs(m,Ys.EventType.ERROR,R=>{_||(_=!0,_i(At,`RPC '${e}' stream ${i} transport errored. Name:`,R.name,"Message:",R.message),C.o_(new oe(U.UNAVAILABLE,"The operation could not be completed")))}),Hs(m,Ys.EventType.MESSAGE,R=>{var k;if(!_){const D=R.data[0];Ne(!!D,16349);const b=D,g=(b==null?void 0:b.error)||((k=b[0])==null?void 0:k.error);if(g){J(At,`RPC '${e}' stream ${i} received error:`,g);const S=g.status;let V=function(v){const y=rt[v];if(y!==void 0)return Jv(y)}(S),j=g.message;S==="NOT_FOUND"&&j.includes("database")&&j.includes("does not exist")&&j.includes(this.databaseId.database)&&_i(`Database '${this.databaseId.database}' not found. Please check your project configuration.`),V===void 0&&(V=U.INTERNAL,j="Unknown error status: "+S+" with message "+g.message),_=!0,C.o_(new oe(V,j)),m.close()}else J(At,`RPC '${e}' stream ${i} received:`,D),C.__(D)}}),ns.u_(),setTimeout(()=>{C.s_()},0),C}terminate(){this.a_.forEach(e=>e.close()),this.a_=[]}E_(e){this.a_.push(e)}I_(e){this.a_=this.a_.filter(n=>n===e)}Go(e,n,r){super.Go(e,n,r),this.databaseInfo.apiKey&&(e["x-goog-api-key"]=this.databaseInfo.apiKey)}createWebChannelTransport(){return _v()}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
